var app = function() {
	...
	function mount_component(e, t, n) {
		const {
			fragment: r,
			on_mount: i,
			on_destroy: s,
		...
		r && r.m(t, n), add_render_callback((() => {
			const t = i.map(run).filter(is_function);
			s ? s.push(...t) : run_all(t), e.$$.on_mount = []
	...
	function init(e, t, n, r, i, s, o = [-1]) {
		...
		let u = !1;
		if (c.ctx = n ? n(e, l, ((t, n, ...r) => {
				const s = r.length ? r[0] : n;
				return c.ctx && i(c.ctx[t], c.ctx[t] = s) && (!c.skip_bound && c.bound[t] && c.bound[t](s), u && make_dirty(e, t)), n
			})) : [], c.update(), u = !0, run_all(c.before_update), c.fragment = !!r && r(c.ctx), t.target) {
			if (t.hydrate) {
				const e = children(t.target);
				c.fragment && c.fragment.l(e), e.forEach(detach)
			} else c.fragment && c.fragment.c();
			t.intro && transition_in(e.$$.fragment), mount_component(e, t.target, t.anchor), flush()
		}
					...
					return n._events[e] = n._events[e].filter((function(e) {
						...
						var e = _asyncToGenerator((function*(e) {
							...
							if ("none" !== e.status) {
								...
								try {
									return "function" == typeof(null != (i = "function" == typeof e.cb ? e.cb(...t) : void 0) ? i.then : void 0) ?
										yield i : i
								} catch (e) {
	...
	var BottleneckError_1 = BottleneckError,
		BottleneckError$1, DEFAULT_PRIORITY, Job, NUM_PRIORITIES, parser$1;
	...
	NUM_PRIORITIES = 10, DEFAULT_PRIORITY = 5, parser$1 = parser, BottleneckError$1 = BottleneckError_1, Job = class {
		constructor(e, t, n, r, i, s, o, a) {
			this.task = e, this.args = t, this.rejectOnDrop = i, this.Events = s, this._states = o, this.Promise = a, this.options = parser$1.load(n, r), this.options.priority = this._sanitizePriority(this.options.priority), this.options.id === r.id && (this.options.id = `${this.options.id}-${this._randomIndex()}`), this.promise = new this.Promise(((e, t) => {
				this._resolve = e, this._reject = t
			})), this.retryCount = 0
		}
		_sanitizePriority(e) {
			var t;
			return (t = ~~e !== e ? DEFAULT_PRIORITY : e) < 0 ? 0 : t > NUM_PRIORITIES - 1 ? NUM_PRIORITIES - 1 : t
		}
		_randomIndex() {
		...
		doDrop({
			...
			return !!this._states.remove(this.options.id) && (this.rejectOnDrop && this._reject(null != e ? e : new BottleneckError$1(t)), this.Events.trigger("dropped", {
				args: this.args,
		...
		_assertStatus(e) {
			var t;
			if ((t = this._states.jobStatus(this.options.id)) !== e && ("DONE" !== e || null !== t)) throw new BottleneckError$1(`Invalid job status ${t}, expected ${e}. Please open an issue at https://github.com/SGrondin/bottleneck/issues`)
		}
		doReceive() {
		...
		doExecute(e, t, n, r) {
			...
			return _asyncToGenerator$1((function*() {
				...
				try {
					if (a =
						yield null != e ? e.schedule(i.options, i.task, ...i.args) : i.task(...i.args), t()) return i.doDone(o),
						yield r(i.options, o), i._assertStatus("DONE"), i._resolve(a)
				} catch (e) {
		...
		doExpire(e, t, n) {
			...
			}, r = new BottleneckError$1(`This job timed out after ${this.options.expiration} ms.`), this._onFailure(r, i, e, t, n)
		}
		_onFailure(e, t, n, r, i) {
			...
			return _asyncToGenerator$1((function*() {
				var o, a;
				if (n()) return null != (o =
					yield s.Events.trigger("failed", e, t)) ? (a = ~~o, s.Events.trigger("retry", `Retrying ${s.options.id} after ${a} ms`, t), s.retryCount++, r(a)) : (s.doDone(t),
					yield i(s.options, t), s._assertStatus("DONE"), s._reject(e))
			}))()
		}
		doDone(e) {
	...
	var Job_1 = Job,
		BottleneckError$2, LocalDatastore, parser$2;
	...
	parser$2 = parser, BottleneckError$2 = BottleneckError_1, LocalDatastore = class {
		constructor(e, t, n) {
			this.instance = e, this.storeOptions = t, this.clientId = this.instance._randomIndex(), parser$2.load(n, n, this), this._nextRequest = this._lastReservoirRefresh = this._lastReservoirIncrease = Date.now(), this._running = 0, this._done = 0, this._unblockTime = 0, this.ready = this.Promise.resolve(), this.clients = {}, this._startHeartbeat()
		}
		_startHeartbeat() {
			var e;
		...
		__updateSettings__(e) {
			var t = this;
			return _asyncToGenerator$2((function*() {
				return yield t.yieldLoop(), parser$2.overwrite(e, e, t.storeOptions), t._startHeartbeat(), t.instance._drainAll(t.computeCapacity()), !0
			}))()
		}
		__running__() {
			var e = this;
		...
		__submit__(e, t) {
			...
			return _asyncToGenerator$2((function*() {
				var r, i, s;
				if (
					yield n.yieldLoop(), null != n.storeOptions.maxConcurrent && t > n.storeOptions.maxConcurrent) throw new BottleneckError$2(`Impossible to add a job having a weight of ${t} to a limiter having a maxConcurrent setting of ${n.storeOptions.maxConcurrent}`);
	...
	var require$$0 = {
		...
		Scripts = createCommonjsModule((function(e, t) {
			var n, r, i;
			n = {
				refs: (r = require$$0)["refs.lua"],
				validate_keys: r["validate_keys.lua"],
				validate_client: r["validate_client.lua"],
				refresh_expiration: r["refresh_expiration.lua"],
				process_tick: r["process_tick.lua"],
				conditions_check: r["conditions_check.lua"],
				get_time: r["get_time.lua"]
				...
				group_check: {
					...
					code: r["group_check.lua"]
				},
				register_client: {
					keys: t.allKeys,
					headers: ["validate_keys"],
					refresh_expiration: !1,
					code: r["register_client.lua"]
				},
				blacklist_client: {
					keys: t.allKeys,
					headers: ["validate_keys", "validate_client"],
					refresh_expiration: !1,
					code: r["blacklist_client.lua"]
				},
				heartbeat: {
					keys: t.allKeys,
					headers: ["validate_keys", "validate_client", "process_tick"],
					refresh_expiration: !1,
					code: r["heartbeat.lua"]
				},
				update_settings: {
					keys: t.allKeys,
					headers: ["validate_keys", "validate_client", "process_tick"],
					refresh_expiration: !0,
					code: r["update_settings.lua"]
				},
				running: {
					keys: t.allKeys,
					headers: ["validate_keys", "validate_client", "process_tick"],
				...
				current_reservoir: {
					...
					headers: ["validate_keys", "validate_client", "process_tick"],
					refresh_expiration: !1,
					code: r["current_reservoir.lua"]
				},
				increment_reservoir: {
					keys: t.allKeys,
					headers: ["validate_keys", "validate_client", "process_tick"],
					refresh_expiration: !0,
					code: r["increment_reservoir.lua"]
				}
			}, t.names = Object.keys(i), t.keys = function(e, t) {
				return i[e].keys(t)
			}, t.payload = function(e) {
				var t;
				return t = i[e], Array.prototype.concat(n.refs, t.headers.map((function(e) {
					return n[e]
				})), t.refresh_expiration ? n.refresh_expiration : "", t.code).join("\n")
			}
		})),
		Events$2, RedisConnection, Scripts$1, parser$3;
		...
		class RedisConnection {
			...
			_loadScript(e) {
				return new this.Promise(((t, n) => {
					var r;
					return r = Scripts$1.payload(e), this.client.multi([
						["script", "load", r]
					]).exec(((r, i) => null != r ? n(r) : (this.shas[e] = i[0], t(i[0]))))
				}))
			}
			_loadScripts() {
				return this.Promise.all(Scripts$1.names.map((e => this._loadScript(e))))
			}
			__runCommand__(e) {
				var t = this;
			...
			__removeLimiter__(e) {
				...
				return this.Promise.all([e.channel(), e.channel_client()].map(function() {
					var e = _asyncToGenerator$3((function*(e) {
						return t.terminated || (
							yield new t.Promise(((n, r) => t.subscriber.unsubscribe(e, (function(t, i) {
			...
			__scriptArgs__(e, t, n, r) {
				var i;
				return i = Scripts$1.keys(e, t), [this.shas[e], i.length].concat(i, n, r)
			}
			__scriptFn__(e) {
	...
	var RedisConnection_1 = RedisConnection,
		Events$3, IORedisConnection, Scripts$2, parser$4;
	...
	parser$4 = parser, Events$3 = Events_1, Scripts$2 = Scripts, IORedisConnection = function() {
		class IORedisConnection {
			...
			_loadScripts() {
				return Scripts$2.names.forEach((e => this.client.defineCommand(e, {
					lua: Scripts$2.payload(e)
				})))
			}
			__runCommand__(e) {
				var t = this;
				return _asyncToGenerator$4((function*() {
					yield t.ready;
					var n = _slicedToArray(
							yield t.client.pipeline([e]).exec(), 1),
			...
			__removeLimiter__(e) {
				...
				return [e.channel(), e.channel_client()].forEach(function() {
					var e = _asyncToGenerator$4((function*(e) {
						return t.terminated || (
							yield t.subscriber.unsubscribe(e)), delete t.limiters[e]
					}));
					return function(t) {
						return e.apply(this, arguments)
					}
			...
			__scriptArgs__(e, t, n, r) {
				var i;
				return [(i = Scripts$2.keys(e, t)).length].concat(i, n, r)
			}
			__scriptFn__(e) {
	...
	var IORedisConnection_1 = IORedisConnection,
		BottleneckError$3, IORedisConnection$1, RedisConnection$1, RedisDatastore, parser$5;
	...
	parser$5 = parser, BottleneckError$3 = BottleneckError_1, RedisConnection$1 = RedisConnection_1, IORedisConnection$1 = IORedisConnection_1, RedisDatastore = class {
		constructor(e, t, n) {
			this.instance = e, this.storeOptions = t, this.originalId = this.instance.id, this.clientId = this.instance._randomIndex(), parser$5.load(n, n, this), this.clients = {}, this.capacityPriorityCounters = {}, this.sharedConnection = null != this.connection, null == this.connection && (this.connection = "redis" === this.instance.datastore ? new RedisConnection$1({
				Redis: this.Redis,
		...
		__publish__(e) {
			...
			return _asyncToGenerator$5((function*() {
				return (
					yield t.ready).client.publish(t.instance.channel(), "message:" + e.toString())
			}))()
		}
		onMessage(e, t) {
			var n = this;
			return _asyncToGenerator$5((function*() {
				...
				try {
					...
					if ("capacity-priority" === h) {
						var d = _slicedToArray$1(i.split(":"), 3);
						return u = d[0], c = d[1], r = d[2], e = u.length > 0 ? ~~u : void 0, c === n.clientId ? (s =
							yield n.instance._drainAll(e), a = null != e ? e - (s || 0) : "",
							yield n.clients.client.publish(n.instance.channel(), `capacity-priority:${a}::${r}`)) : "" === c ? (clearTimeout(n.capacityPriorityCounters[r]), delete n.capacityPriorityCounters[r], n.instance._drainAll(e)) : n.capacityPriorityCounters[r] = setTimeout(_asyncToGenerator$5((function*() {
							var t;
							try {
								return delete n.capacityPriorityCounters[r],
									yield n.runScript("blacklist_client", [c]),
		...
		runScript(e, t) {
			var n = this;
			return _asyncToGenerator$5((function*() {
				return "init" !== e && "register_client" !== e && (
					yield n.ready), new n.Promise(((r, i) => {
					var s, o;
		...
		__updateSettings__(e) {
			var t = this;
			return _asyncToGenerator$5((function*() {
				return yield t.runScript("update_settings", t.prepareObject(e)), parser$5.overwrite(e, e, t.storeOptions)
			}))()
		}
		__running__() {
		...
		__check__(e) {
			var t = this;
			return _asyncToGenerator$5((function*() {
				return t.convertBool(
					yield t.runScript("check", t.prepareArray([e])))
			}))()
		}
		__register__(e, t, n) {
			var r = this;
			return _asyncToGenerator$5((function*() {
				var i, s, o, a = _slicedToArray$1(
					yield r.runScript("register", r.prepareArray([e, t, n])), 3);
		...
		__submit__(e, t) {
			...
			return _asyncToGenerator$5((function*() {
				var r, i, s, o, a;
				try {
					var l = _slicedToArray$1(
						yield n.runScript("submit", n.prepareArray([e, t])), 3);
					...
					if (0 === (i = e).message.indexOf("OVERWEIGHT")) {
						var c = _slicedToArray$1(i.message.split(":"), 3);
						throw c[0], t = c[1], s = c[2], new BottleneckError$3(`Impossible to add a job having a weight of ${t} to a limiter having a maxConcurrent setting of ${s}`)
					}
					throw i
				}
			}))()
	...
	var RedisDatastore_1 = RedisDatastore,
		BottleneckError$4, States;
	BottleneckError$4 = BottleneckError_1, States = class {
		constructor(e) {
		...
		statusJobs(e) {
			var t, n, r, i;
			if (null != e) {
				if ((n = this.status.indexOf(e)) < 0) throw new BottleneckError$4("status must be one of " + this.status.join(", "));
	...
	DLList$2 = DLList_1, Sync = class {
		constructor(e, t) {
			this.schedule = this.schedule.bind(this), this.name = e, this.Promise = t, this._running = 0, this._queue = new DLList$2
		}
		isEmpty() {
		...
		_tryToRun() {
			...
			return _asyncToGenerator$6((function*() {
				...
				if (e._running < 1 && e._queue.length > 0) {
					...
					return a = l.task, t = l.args, s = l.resolve, i = l.reject, n =
						yield _asyncToGenerator$6((function*() {
							try {
								return o =
									yield a(...t),
									function() {
	...
	var Sync_1 = Sync,
		...
		Events$4, Group, IORedisConnection$2, RedisConnection$2, Scripts$3, parser$6;
	...
	parser$6 = parser, Events$4 = Events_1, RedisConnection$2 = RedisConnection_1, IORedisConnection$2 = IORedisConnection_1, Scripts$3 = Scripts, Group = function() {
		class e {
			constructor(e = {}) {
				this.deleteKey = this.deleteKey.bind(this), this.limiterOptions = e, parser$6.load(this.limiterOptions, this.defaults, this), this.Events = new Events$4(this), this.instances = {}, this.Bottleneck = Bottleneck_1, this._startAutoCleanup(), this.sharedConnection = null != this.connection, null == this.connection && ("redis" === this.limiterOptions.datastore ? this.connection = new RedisConnection$2(Object.assign({}, this.limiterOptions, {
					Events: this.Events
				})) : "ioredis" === this.limiterOptions.datastore && (this.connection = new IORedisConnection$2(Object.assign({}, this.limiterOptions, {
					Events: this.Events
				}))))
			}
			key(e = "") {
			...
			deleteKey(e = "") {
				...
				return _asyncToGenerator$7((function*() {
					var n, r;
					return r = t.instances[e], t.connection && (n =
						yield t.connection.__runCommand__(["del", ...Scripts$3.allKeys(`${t.id}-${e}`)])), null != r && (delete t.instances[e],
						yield r.disconnect()), null != r || n > 0
				}))()
			}
			limiters() {
				var e, t, n, r;
			...
			clusterKeys() {
				...
				return _asyncToGenerator$7((function*() {
					...
					for (o = [], t = null, l = `b_${e.id}-`.length, n = "_settings".length; 0 !== t;) {
						var c = _slicedToArray$2(
							yield e.connection.__runCommand__(["scan", null != t ? t : 0, "match", `b_${e.id}-*_settings`, "count", 1e4]), 2);
			...
			_startAutoCleanup() {
				var e, t = this;
				return clearInterval(this.interval), "function" == typeof(e = this.interval = setInterval(_asyncToGenerator$7((function*() {
					var e, n, r, i, s, o;
			...
			updateSettings(e = {}) {
				if (parser$6.overwrite(e, this.defaults, this), parser$6.overwrite(e, e, this.limiterOptions), null != e.timeout) return this._startAutoCleanup()
			}
			disconnect(e = !0) {
				var t;
	...
	var Group_1 = Group,
		Batcher, Events$5, parser$7;
	parser$7 = parser, Events$5 = Events_1, Batcher = function() {
		class e {
			constructor(e = {}) {
				this.options = e, parser$7.load(this.options, this.defaults, this), this.Events = new Events$5(this), this._arr = [], this._resetPromise(), this._lastFlush = Date.now()
			}
			_resetPromise() {
	...
	function _toArray(e) {
		return _arrayWithHoles$3(e) || _iterableToArray(e) || _nonIterableRest$3()
	}
	...
	var Bottleneck, DEFAULT_PRIORITY$1, Events$6, Job$1, LocalDatastore$1, NUM_PRIORITIES$1, Queues$1, RedisDatastore$1, States$1, Sync$1, parser$8, splice = [].splice;
	NUM_PRIORITIES$1 = 10, DEFAULT_PRIORITY$1 = 5, parser$8 = parser, Queues$1 = Queues_1, Job$1 = Job_1, LocalDatastore$1 = LocalDatastore_1, RedisDatastore$1 = RedisDatastore_1, Events$6 = Events_1, States$1 = States_1, Sync$1 = Sync_1, Bottleneck = function() {
		class e {
			constructor(t = {}, ...n) {
				var r, i;
				this._addToQueue = this._addToQueue.bind(this), this._validateOptions(t, n), parser$8.load(t, this.instanceDefaults, this), this._queues = new Queues$1(NUM_PRIORITIES$1), this._scheduled = {}, this._states = new States$1(["RECEIVED", "QUEUED", "RUNNING", "EXECUTING"].concat(this.trackDoneStatus ? ["DONE"] : [])), this._limiter = null, this.Events = new Events$6(this), this._submitLock = new Sync$1("submit", this.Promise), this._registerLock = new Sync$1("register", this.Promise), i = parser$8.load(t, this.storeDefaults, {}), this._store = function() {
					if ("redis" === this.datastore || "ioredis" === this.datastore || null != this.connection) return r = parser$8.load(t, this.redisStoreDefaults, {}), new RedisDatastore$1(this, i, r);
					if ("local" === this.datastore) return r = parser$8.load(t, this.localStoreDefaults, {}), new LocalDatastore$1(this, i, r);
			...
			_free(e, t, n, r) {
				...
				return _asyncToGenerator$8((function*() {
					...
					try {
						if (s = (
								yield i._store.__free__(e, n.weight)).running, i.Events.trigger("debug", "Freed " + n.id, r), 0 === s && i.empty()) return i.Events.trigger("idle")
					} catch (e) {
			...
			stop(t = {}) {
				var n, r;
				return t = parser$8.load(t, this.stopDefaults), r = e => {
					var t;
					return t = () => {
						var t;
			...
			_addToQueue(t) {
				...
				return _asyncToGenerator$8((function*() {
					...
					try {
						var u =
							yield n._store.__submit__(n.queued(), o.weight);
			...
			submit(...e) {
				var t, n, r, i, s, o, a, l;
				"function" == typeof e[0] ? (s = _toArray(e), n = s[0], e = s.slice(1), o = _slicedToArray$3(splice.call(e, -1), 1), t = o[0], i = parser$8.load({}, this.jobDefaults)) : (i = (a = _toArray(e))[0], n = a[1], e = a.slice(2), l = _slicedToArray$3(splice.call(e, -1), 1), t = l[0], i = parser$8.load(i, this.jobDefaults));
				return (r = new Job$1(((...e) => new this.Promise((function(t, r) {
					return n(...e, (function(...e) {
						return (null != e[0] ? r : t)(e)
					}))
				}))), e, i, this.jobDefaults, this.rejectOnDrop, this.Events, this._states, this.Promise)).promise.then((function(e) {
			...
			schedule(...e) {
				...
				return t = new Job$1(r, e, n, this.jobDefaults, this.rejectOnDrop, this.Events, this._states, this.Promise), this._receive(t), t.promise
			}
			wrap(e) {
				var t, n;
			...
			updateSettings(e = {}) {
				var t = this;
				return _asyncToGenerator$8((function*() {
					return yield t._store.__updateSettings__(parser$8.overwrite(e, t.storeDefaults)), parser$8.overwrite(e, t.instanceDefaults, t), t
				}))()
			}
			currentReservoir() {
		...
		return e.default = e, e.Events = Events$6, e.version = e.prototype.version = require$$8.version, e.strategy = e.prototype.strategy = {
			LEAK: 1,
			OVERFLOW: 2,
			OVERFLOW_PRIORITY: 4,
			BLOCK: 3
	...
	class Bulma extends SvelteComponent {
		constructor(e) {
			super(), init(this, e, null, null, safe_not_equal, {})
		}
	}
	...
	function create_fragment(e) {
		...
		return {
			c() {
				...
				insert(i, t, s), set_input_value(t, e[0]), e[3](t), n || (r = listen(t, "input", e[2]), n = !0)
			}, p(e, [n]) {
				1 & n && set_input_value(t, e[0])
			}, i: noop, o: noop, d(i) {
				i && detach(t), e[3](null), n = !1, r()
			}
		}
	}
	...
	function create_else_block_1(e) {
		...
		return {
			c() {
				t = element("span"), t.textContent = "Live token:", attr(t, "class", "tag is-success")
			}, m(e, n) {
				insert(e, t, n)
			}, p: noop, d(e) {
				e && detach(t)
	...
	function create_if_block_1(e) {
		...
		return {
			c() {
				t = element("span"), n = text("Live token: "), r = text(e[4]), attr(t, "class", "tag is-success")
			}, m(e, i) {
				insert(e, t, i), append(t, n), append(t, r)
			}, p(e, t) {
				16 & t && set_data(r, e[4])
			}, d(e) {
				e && detach(t)
	...
	function create_else_block(e) {
		...
		return {
			c() {
				t = element("span"), t.textContent = "Expired token:", attr(t, "class", "tag is-danger")
			}, m(e, n) {
				insert(e, t, n)
			}, p: noop, d(e) {
				e && detach(t)
	...
	function create_if_block(e) {
		...
		return {
			c() {
				t = element("span"), n = text("Expired token: "), r = text(e[5]), attr(t, "class", "tag is-danger")
			}, m(e, i) {
				insert(e, t, i), append(t, n), append(t, r)
			}, p(e, t) {
				32 & t && set_data(r, e[5])
	...
	function create_fragment$1(e) {
		let t, n, r, i, s, o, a, l, c, u, h, _, d, p, v, m, y, f, g, b, k, $, w, x, R, E, T, I, S, C, O, A, P, G, L, j, q, D, B, N, M, K, z, W, F, U, V, H;

		function Q(e, t) {
			return e[4] > 0 ? create_if_block_1 : create_else_block_1
		}
		t = new Bulma({});
		let Y = Q(e),
			J = Y(e);
	...
	function instance$1(e, t, n) {
		...
		return [i, s, o, a, l, c, u, async() => {
			s.split(/\r?\n/).filter((e => e.length > 0)).map((async e => {
				const t = /EA[\w]{170,210}/.exec(e.trim())[0];
				r.schedule((() => fetch("https://graph.facebook.com/me?access_token=" + t))).then((e => e.json())).then((r => {
					Object.prototype.hasOwnProperty.call(r, "id") ? (n(2, o = i ? o + t + "\n" : o + e.trim() + "\n"), n(4, l++, l)) : (n(3, a = i ? a + t + "\n" : a + e.trim() + "\n"), n(5, c++, c))
				}))
			}))
		}, () => {
			n(1, s = ""), n(2, o = ""), n(3, a = ""), n(4, l = 0), n(5, c = 0)
		}, function() {
